...
$task_name = htmlspecialchars($_POST['tName'], ENT_QUOTES, 'UTF-8');
$due = $_POST['reschedule-due'];
...
$update = [
    '$set' => [
        'todo_list.$[outer].tasks.$[inner].due' => $due
    ]
];
...
if ($result->getModifiedCount() > 0) {
    echo "due-update: Data updated successfully.";
} else {
    echo "due-update: No documents matched the filter criteria.";
}
