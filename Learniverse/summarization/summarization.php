    ...
    <div class="container">
      ...
      <div class="summary-container">
        ...
        <div class="summarize-container">
          <p class="summarize-text">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ratione
            accusamus fuga iure voluptate debitis nesciunt error ea, voluptatem
            quisquam! A dignissimos vitae tempore quia perspiciatis culpa,
            expedita explicabo cupiditate. Voluptatibus? Eum quaerat iure animi
            hic placeat voluptatibus, perspiciatis autem odit temporibus. Ea,
            recusandae perspiciatis maiores id laudantium architecto voluptatum,
            beatae dolorum iste minima voluptate qui eveniet quos ab nostrum
            error. Velit quae molestias, officia natus, possimus tenetur, ex
            quod odit ullam mollitia error! Impedit, commodi placeat eaque
            deleniti velit, numquam, autem facilis in repellendus optio fugit
            mollitia ipsum omnis maxime?
          </p>
        </div>
      </div>
    </div>
