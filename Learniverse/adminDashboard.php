  ...
  .then((result) => {
    ...
    <main style="margin-top: 5%;">
        ...
        <div class="tabs">
            ...
            <button class="tablinks" onclick="openTab(event, 'Community')"><i class='far fa-envelope-open' title="Community"></i></button>
            <button class="tablinks" onclick="openTab(event, 'customerReport')"><i class='far fa-question-circle' title="customerReport"></i></button>
        </div>
        <!-- Tab content -->
        ...
        <table
        class="table table-hover table-nowrap table-striped table-bordered mt-10"
      >
        ...
        <div id="customerReport" class="tabcontent">
            ...
            if (empty($complaints)) {
                echo "<h2 style='margin: 20px 0;'>No unresolved complaints to display.</h2>";
            } else {
                echo "<h2 style='margin: 20px 0;'>Unresolved complaints</h2>";
                echo "<div class='row'>";
            ...
            if (empty($complaints)) {
                echo "<h2 style='margin: 20px 0;'>No pending complaints to display.</h2>";
            } else {
                echo "<h2 style='margin: 20px 0;'>Pending complaints</h2>";
                echo "<div class='row'>";
                foreach ($complaints as $complaint) {
                    // Select the database and collection
                    $database = $connection->Learniverse;
            ...
            if (empty($complaints)) {
                echo "<h2 style='margin: 20px 0;'>No Resolved complaints to display.</h2>";
            } else {
                echo "<h2 style='margin: 20px 0;'>Resolved complaints</h2>";
                echo "<div class='row'>";
                foreach ($complaints as $complaint) {
                    // Select the database and collection
                    $database = $connection->Learniverse;
